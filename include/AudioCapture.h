 ...
 * Automatically converts audio to the format required by Whisper (16kHz, mono,
 * float32).
 */
class AudioCapture {
public:
...
private:
   ...
   */
  void processAudioData(const void *inputBuffer, unsigned int frames,
                        double timestamp);
   ...
   */
  std::vector<float> convertToFloat(const void *input, unsigned int frames,
                                    int format) const;
};