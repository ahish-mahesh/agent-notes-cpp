    ...
    int sample_rate)
{
    ...
    {
        wparams.vad = true;
        wparams.vad_model_path = ctx->params.vad_model_path;
        wparams.vad_params.threshold = ctx->params.vad_threshold;
        wparams.vad_params.min_silence_duration_ms = ctx->params.min_silence_duration_ms;
        wparams.vad_params.speech_pad_ms = ctx->params.speech_pad_ms;
        wparams.single_segment = false; // Allow multiple segments for better boundaries
    }
